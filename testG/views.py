...
from pygame.math import Vector2 #0821추가
import pygame, random, sys, time
from pygame.constants import KEYDOWN    #0821 추가


#from datetime import datetime 0821 삭제
#from datetime import timedelta 0821 삭제
